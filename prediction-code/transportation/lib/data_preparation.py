...
def read_and_generate_dataset(graph_signal_matrix_filename,generated_adj_filename,
    ...
    data_seq = data_seq[1:adj.shape[0]+1,:,:]
    ...
    if graph_signal_matrix_filename == 'data/Tdrive/Tdrive.npz':
        split_line1 = int(len(all_samples) * 0.65)
        split_line2 = int(len(all_samples) * 0.7)
    if graph_signal_matrix_filename == 'data/Los_loop/Los_loop.npz':
        split_line1 = int(len(all_samples) * 0.535)
        split_line2 = int(len(all_samples) * 0.765)
    if graph_signal_matrix_filename == 'data/PEMS08/PEMS08.npz':
